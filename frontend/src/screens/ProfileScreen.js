...
import {Table , Form , FormGroup , FormLabel  , Row , Col, FormControl} from 'react-bootstrap'
       ...
       <Row>
        ...
        <Button
            ...
            // variant="outlined"
             type="submit"
            //  disabled = {isLoading}
            style={{marginTop: "15px", color: 'black', border : '1px solid black', padding: '5px 20px' }}
          >
            Submit
          </Button>
</div>
