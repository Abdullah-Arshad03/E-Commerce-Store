...
export const {useCreateOrderMutation , useGetOrderByIdQuery , useGetPaypalClientIdQuery , usePayOrderMutation , useLoggedInOrdersQuery , useGetOrderListQuery, useDeliverOrderMutation} = orderApiSlice